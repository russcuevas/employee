...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($existing_record) {
        ...
        // Insert a new timekeeping record with the log_date, log_in, and attendance_date
        $stmt = $conn->prepare("INSERT INTO timekeeping (user_id, log_date, log_in, attendance_date, present, absent) VALUES (?, ?, ?, ?, 1, 0)");
        if ($stmt->execute([$user_id, $log_date, $log_in, $attendance_date])) {
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <!-- Left Column (Time In Form) -->
                    <div class="col-lg-6 col-md-12 mb-4">
                        <div class="card shadow-sm">
                            <div class="card-header bg-primary text-white">
                                <h5 class="card-title mb-0">Time In</h5>
                            </div>
                            <div class="card-body">
                                <form id="quickForm" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="time" name="log_in" id="log_in" required readonly>
                                    </div>
    ...
    <script>
        function updateTime() {
            ...
            document.getElementById('log_in').value = hours24 + ':' + minutes24;
        }
